    ...
    return (
      <Card className="max-w-2xl" data-testid="ai-engineer-model-config-editor">
        <CardHeader>
          ...
          <CardDescription>
            {loadError?.message ||
              "The platform could not load the model registry file. Ensure AI_ENGINEER_MODELS_CONFIG_PATH is set and the file exists (see models.local.yaml.example in agent-runtime)."}
          </CardDescription>
        </CardHeader>
      </Card>
    );
