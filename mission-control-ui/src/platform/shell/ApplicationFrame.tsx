    ...
    <div className="flex min-h-full items-center justify-center px-6 py-10">
      <div className="bg-background/95 w-full max-w-xl rounded-2xl border p-8 shadow-[0_24px_80px_rgba(0,0,0,0.18)]">
        <div className="flex items-start gap-4">
          <span className="bg-amber-500/12 text-amber-300 inline-flex size-12 items-center justify-center rounded-2xl">
            <AlertTriangle className="size-5" />
          </span>
          <div>
            <p className="text-xs font-semibold tracking-[0.2em] uppercase text-amber-300/90">Platform Shell</p>
